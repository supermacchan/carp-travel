...
export const About = () => {
    return (
        <section 
            id="about" 
            className="bg-bg-about-mob bg-cover bg-no-repeat bg-center 
                tab:bg-bg-about-tab desk:bg-bg-about-desk"
        >
            <Overlay>
                <div className="section px-5 py-[55px] mx-auto text-white
                    tab:px-8 tab:py-16 tab:h-[697px] tab:relative
                    desk:px-6 desk:py-[104px] desk:h-[824px]">
                    <h2 className="title mb-2">
                        Who <span className="font-medium">we are</span>
                    </h2>
                    
                    <div className="w-[180px] text-sm font-extralight leading-5
                        ...
                        <p className="mb-5 tab:mb-4 desk:mb-6"> 
                            <span className="font-normal">a team of enthusiasts</span> who are fully committed to the mission of creating unforgettable and extraordinary trips to the most beautiful parts of the Carpathians. Our goal is not just to show you the natural wonders of the mountains, but to provide you with a deep immersion in their magical atmosphere.
                        </p>
                        <p className="mb-10 tab:mb-0">
                            <span className="font-normal">We believe</span> that nature has the power to inspire, strengthen character and provide new perspectives. Therefore, each of our tours is aimed at unlocking your potential, enriching your spiritual world and creating unforgettable memories.
                        </p>
                    </div>
                    
                    <div className="ml-auto mb-10 w-[180px] text-sm font-normal leading-5
                        tab:w-[221px] tab:mb-0 tab:absolute tab:bottom-[188px] tab:left-8 tab:text-base tab:leading-[20px]
                        ...
                        <span className="mr-[-15px] block font-extralight tracking-[-0.14px] tab:tracking-[0.32px] desk:mr-[-20px] desk:tracking-[2.16px]">we have a tour for everyone.</span>
                    </div>
