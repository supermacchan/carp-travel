    ...
    return (
        <section 
            className="mt-[-105px] pt-[105px]
                ...
                tab:mt-[-124px] tab:pt-[124px] tab:bg-bg-hero-tab desk:bg-bg-hero-desk
        ...
        >
            <Overlay overlay="overlay">
                ...
                >
                    ...
                    <h2 
                        className="title mb-6 w-[280px] flex flex-col 
                    ...
                    >
                        ...
                        >
                            ...
                            Enjoy stunning views, exciting expeditions, and the best service!
                        </p>
                        ...
                        <button 
                            ...
                            className="mx-auto px-16 py-[18px] w-[280px] relative bg-white bg-opacity-10 
                                ...
                                before:w-[42px] before:h-[53px] before:absolute before:top-0 before:left-0 
                                before:bg-mob-button-left before:bg-opacity-100
                                after:w-[42px] after:h-[53px] after:absolute after:top-0 after:right-0 
                                after:bg-mob-button-right after:bg-opacity-100
